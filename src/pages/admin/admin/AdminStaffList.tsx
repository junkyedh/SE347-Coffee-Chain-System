...
const AdminStaffList = () => {
  ...
  useEffect(() => {
    fetchBranchList();
    fetchStaffList();
  }, [fetchBranchList, fetchStaffList]);
        ...
        <div className="header-actions">
          ...
          <div className="d-flex">
            <Upload beforeUpload={handleImportExcel} showUploadList={false} accept=".xlsx, .xls">
              <AdminButton variant="primary" size="sm" icon={<UploadOutlined />} />
            </Upload>
            <AdminButton
              variant="primary"
              size="sm"
      ...
      >
        <Form form={staffForm} layout="vertical">
          ...
          <div className="modal-footer-custom">
            ...
            <AdminButton variant="primary" size="sm" onClick={onSubmitStaff}>
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            dataIndex: 'typeStaff',
            key: 'typeStaff',
            sorter: (a, b) => a.typeStaff.localeCompare(b.typeStaff),
          },
          ...
          },
          {
            ...
            render: (value: string) => (value ? moment(value).format('DD-MM-YYYY HH:mm:ss') : '-'),
          },
          {
            title: 'Hành động',
            key: 'actions',
